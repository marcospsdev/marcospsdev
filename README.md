...
Hello! My name is Marcos Paulo, I'm 25 years old and I'm from Fortaleza, Ceará. I work as a Full-Stack Developer with 7 years of experience, and as a Quality Analyst with 4 years of experience. My passion is creating robust, high-performance web solutions with a focus on the best user experience.

I specialize in Front-end (Angular, React, TypeScript), Back-end (Node.js, RESTful APIs), and DevOps (Docker, CI/CD). I am proficient in agile methodologies like Scrum and in code best practices, such as Clean Code and SOLID. In the QA field, I have vast experience in automated testing (Cypress, Jest), API testing, and BDD.
...
-   Performed manual and exploratory tests on web applications and APIs, using the **BDD** approach.
...
-   Focused on REST API integration and creating intuitive user interfaces (UX).
...
-   **Degree in Systems Analysis and Development** (2019 - 2021) - Unifametro
-   **Computer Science Technician** (2016 - 2018) - EEEP Dona Creusa do Carmo Rocha
-   **Cypress, from Zero to Cloud** (Udemy)
-   **React JS Bootcamp** (Udemy)
-   **Angular 17 Bootcamp** (Udemy)
